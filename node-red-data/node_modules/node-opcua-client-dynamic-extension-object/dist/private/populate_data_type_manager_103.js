...
async function _extractDataTypeDictionary(session, d, dataTypeManager) {
    ...
    if (!_isOldDataTypeDictionary(d)) {
        if (doDebug) {
            ...
            doDebug && debugLog("DataTypeDictionary is deprecated or BSD schema stored in dataValue is null !", chalk_1.default.cyan(name.value.value.toString()), "namespace =", namespace);
...
async function populateDataTypeManager103(session, dataTypeManager) {
    ...
    for (const d of dataTypeDictionaryInfo) {
        ...
        doDebug && debugLog(" fixing based dataTypeFactory dependencies for  ", d.targetNamespace, "index = ", d.dataTypeDictionaryNodeId.namespace);
        ...
        for (const namespace of Object.values(d.dependencies)) {
            ...
            if (dataTypeManager.hasDataTypeFactory(namespaceIndex)) {
                ...
                doDebug && debugLog("   considering , ", baseDataFactory.targetNamespace, "index = ", baseDataFactory.dataTypeDictionaryNodeId.namespace);
            }
        }
