 ...
 ******************************************************************************/
    ...
    adminAuth: {
       type: "credentials",
       users: [{
           username: "idpm", // process.env.NODE_RED_ADMIN_USER || 
           password: "$2y$10$D8GeOmm.ax6Vkq21U1064ub7nlg8yW.JvBO4zSv0wjsSJZICDs0vu", // ansbach process.env.NODE_RED_ADMIN_PASSWORD
           permissions: "*"
       }]
    },
